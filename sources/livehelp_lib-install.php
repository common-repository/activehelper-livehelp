...
function activeHelper_liveHelp_installQuery()
{
	$installQuery = "
		...
		INSERT INTO wp_livehelp_languages VALUES ('jp', 'Japanese', 'utf-8');
...
if ($database_version == "3.8.0") {
 ...
 if ($database_version == "3.9.6") {        

     $table_name = $wpdb->prefix . "livehelp_languages"; 
	 $sql ="INSERT INTO $table_name VALUES ('jp', 'Japanese', 'utf-8')"; 
     dbDelta($sql);		
     ...
     $table_name = $wpdb->prefix . "livehelp_messages";
   ...
   if ($database_version == "4.0.0") {                  
       $database_version = "4.1.0";      
     } 
	 
   if ($database_version == "4.1.0") {                  
       $database_version = "4.2.0";      
     } 
	 
  if ($database_version == "4.2.0") {                  
       $database_version = "4.3.0";      
     } 
	 
  if ($database_version == "4.3.0") {                  
       $database_version = "4.3.1";      
     } 
  if ($database_version == "4.3.1") {                  
       $database_version = "4.5.0";      
     } 
 if ($database_version == "4.5.0") {                  
