...
function processForm() {
        ...
        typing(false);
		 if("<?php echo $_REQUEST["DIRECTION"] ?>"=='1') {
            top.display('<?php echo( htmlentities( (string) $_REQUEST["username"]) ); ?>', message, '<?php echo( htmlentities( (string) $_REQUEST["DIRECTION"]) ); ?>', '0');
		 }
		else {
	       top.display( message, '<?php echo( htmlentities( (string) $_REQUEST["username"]) ); ?>' , '<?php echo( htmlentities( (string) $_REQUEST["DIRECTION"]) ); ?>', '0');
		}
