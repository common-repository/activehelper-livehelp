...
?>
        ...
        function openLiveHelp() {
        var timestamp_get = Math.round(+new Date()/1000);
<?php
...
// Regular chat option for domain
   if(_vlStatus_indicator  && _vlExternalLink ==0 && _vlofftracking ==0 && _vlAgent ==0){
     document.writeln('<a href="<?php echo($server);  echo($server_directory); ?>/<?php echo($eserverName); ?>/index.php?'+timestamp_get+'" id="livechatLink" target="_blank" onclick="s1.openLiveHelp(); s1.closeInfo(); return false">');
